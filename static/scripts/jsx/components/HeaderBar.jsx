            ...
            <div>
                <ButtonToolbar>
                    <ButtonGroup>
                        ...
                        <Button id="headerBarNewButton" title="Start new grammar (hot key: 'command+g' or 'ctrl+g')" onClick={this.props.newGrammar} bsStyle={this.props.newButtonIsJuicing ? 'success' : 'default'}>{this.props.newButtonIsJuicing ? "New!" : "New"}</Button>
                        <Button id="headerBarLoadButton" title={this.props.loadButtonSpinnerOn ? "Loading grammar..." : "Load grammar (hot key: 'command+o' or 'ctrl+o')"} onClick={this.props.openLoadModal} bsStyle={this.props.loadButtonIsJuicing ? 'success' : 'default'} spinColor="#000" loading={this.props.loadButtonSpinnerOn}>{this.props.loadButtonSpinnerOn ? "Loading..." : this.props.loadButtonIsJuicing ? "Loaded!" : "Load"}</Button>
                        <Button title="Save grammar (hot key: 'command+s' or 'ctrl+s')" onClick={this.props.openSaveModal} bsStyle={this.props.saveButtonIsJuicing ? 'success' : 'default'}>{this.props.saveButtonIsJuicing ? "Saved!" : "Save"}</Button>
                        <Button title={this.props.exportButtonSpinnerOn ? "Exporting content bundle..." : this.props.exportButtonDisabled ? "Export content bundle (disabled: requires at least one top-level symbol with a production rule)" : "Export content bundle (hot key: 'command+e' or 'ctrl+e')"} disabled={this.props.exportButtonDisabled} onClick={this.props.openExportModal} bsStyle={this.props.exportButtonIsJuicing ? 'success' : 'default'} spinColor="#000" loading={this.props.exportButtonSpinnerOn}>{this.props.exportButtonSpinnerOn ? "Exporting..." : this.props.exportButtonIsJuicing ? "Exported!" : "Export"}</Button>
                        <Button title={this.props.buildButtonSpinnerOn ? "Building Productionist module..." : this.props.buildButtonDisabled ? "Build Productionist module (disabled: requires exported content bundle)" : "Build Productionist module (hot key: 'command+b' or 'ctrl+b')"} disabled={this.props.buildButtonDisabled} onClick={this.props.attemptToBuildProductionist} bsStyle={this.props.buildButtonIsJuicing ? 'success' : 'default'} spinColor="#000" loading={this.props.buildButtonSpinnerOn}>{this.props.buildButtonSpinnerOn ? "Building..." : this.props.buildButtonIsJuicing ? "Built!" : "Build"}</Button>
                        <Button id="headerBarTestButton" title={this.props.testButtonDisabled ? "Test Productionist module (disabled: requires built Productionist module)" : "Test Productionist module (hot key: 'command+y' or 'ctrl+y')"} disabled={this.props.testButtonDisabled} onClick={this.props.openTestModal} bsStyle='default'>Test</Button>
                    </ButtonGroup>
                </ButtonToolbar>
